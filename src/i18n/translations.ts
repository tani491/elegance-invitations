    ...
    tiers: [
      {
        ...
        priceFcfa: 15000,
        features: [
          "Multi-thèmes personnalisés selon votre univers",
          "Musique d'ambiance intégrée à l'invitation",
          "Itinéraire Google Maps vers la salle",
          "Galerie photos élégante du couple",
        ],
      },
      {
        ...
        features: [
          ...
          "Synchronisation audio raffinée",
          "Effet d'ouverture d'enveloppe 3D",
          "Conciergerie VIP pour la conception Motion",
        ],
      },
    ],
  },
    ...
    tiers: [
      {
        ...
        priceFcfa: 15000,
        features: [
          "Personalised multi-theme experience",
          "Ambient music inside the invitation",
          "Google Maps route to the venue",
          "Elegant couple photo gallery",
        ],
      },
      {
        ...
        features: [
          "Complete 9:16 animation film",
          "Refined audio synchronisation",
          "3D envelope opening effect",
          "VIP concierge guidance for Motion design",
        ],
      },
    ],
  },
    ...
    tiers: [
      {
        ...
        priceFcfa: 15000,
        features: [
          "Multi-temas personalizados según vuestro universo",
          "Música de ambiente integrada",
          "Ruta Google Maps hasta el salón",
          "Galería elegante de fotos de pareja",
        ],
      },
      {
        ...
        features: [
          "Película de animación 9:16 completa",
          "Sincronización de audio refinada",
          "Apertura de sobre 3D",
          "Concierge VIP para el diseño Motion",
        ],
      },
    ],
  },
    ...
    tiers: [
      {
        ...
        priceFcfa: 15000,
        features: [
          "عدة ثيمات مخصصة حسب أجوائكم",
          "موسيقى أجواء مدمجة في الدعوة",
          "مسار Google Maps إلى القاعة",
          "معرض صور أنيق للزوجين",
        ],
      },
      {
        ...
        features: [
          "فيلم أنيميشن كامل بنسبة 9:16",
          "مزامنة صوتية راقية",
          "تأثير فتح ظرف ثلاثي الأبعاد",
          "خدمة كونسيرج VIP لتصميم Motion",
        ],
      },
    ],
  },
