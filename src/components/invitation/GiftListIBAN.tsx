  ...
  return (
    <section className="text-center">
      <div className="mb-6 flex flex-col items-center gap-3">
        ...
        <div>
          <p className="font-serif text-xs font-semibold uppercase tracking-[0.25em] text-amber-900/80">Cadeau</p>
          <h2 className="mt-4 font-serif text-2xl italic tracking-wide text-amber-950">Cadeau des mariés</h2>
        </div>
      </div>
      <div className="mx-auto grid max-w-xs gap-3">
        {iban && (
          <div className="flex items-center justify-between gap-3 rounded-full bg-[#F5EFEB]/70 px-4 py-3 font-serif text-sm text-amber-950/80">
